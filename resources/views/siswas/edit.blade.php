...
<div class="form-wrapper">
    <div class="form-card">
        <h2 class="form-title">Pembaruan Data Siswa</h2>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div class="form-group">
                    ...
                    <select name="jurusan" class="form-control" required>
                        ...
                        <option value="Teknik Komputer dan Jaringan" {{ old('jurusan', $siswa->jurusan) == 'Teknik Komputer dan Jaringan' ? 'selected' : '' }}>Teknik Komputer & Jaringan</option>
