...
<div class="form-wrapper">
    <div class="form-card">
        <h2 class="form-title">Sirkulasi Baru</h2>
        ...
        <form action="{{ route('peminjamans.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="buku_id" class="form-control" required>
                    ...
                    @foreach($bukus as $buku)
                        <option value="{{ $buku->id }}" {{ old('buku_id') == $buku->id ? 'selected' : '' }}>{{ $buku->judul }} (Stok: {{ $buku->stok }})</option>
                    @endforeach
                </select>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="batas_kembali" value="{{ old('batas_kembali', date('Y-m-d', strtotime('+3 days'))) }}" class="form-control" required>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-save"><i class='bx bx-check-circle'></i> Simpan Sirkulasi</button>
            </div>
        </form>
    </div>
</div>
