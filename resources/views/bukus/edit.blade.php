...
<div class="form-wrapper">
    <div class="form-card">
        <h2 class="form-title">Pembaruan Pustaka</h2>
        ...
        <form action="{{ route('bukus.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" style="text-align: center;">
                @if($buku->foto)
                    <img src="{{ asset('uploads/bukus/' . $buku->foto) }}" alt="Foto Buku" style="width: 120px; height: 160px; object-fit: cover; border-radius: 12px; margin-bottom: 15px; border: 2px solid var(--gold); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                @endif
                <div style="text-align: left;">
                    <label class="form-label">Ganti Foto Buku (Opsional)</label>
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stok" value="{{ old('stok', $buku->stok) }}" min="0" class="form-control" required>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-save"><i class='bx bx-check-circle'></i> Perbarui Buku</button>
            </div>
        </form>
    </div>
</div>
